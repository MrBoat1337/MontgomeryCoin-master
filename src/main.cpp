...
int64 nChainStartTime = 1504524963;
...
const string strMessageMagic = "MontgomeryCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if (nHeight == 1)
    {
        nSubsidy = 40000 * COIN;  // 40 Thousand coins
        return nSubsidy + nFees;
    }
    
    // Subsidy is cut in half every 2,500,000,000 blocks, which will occur approximately every 4756 years
    //nSubsidy >>= (nHeight / 2500000000);
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in MontgomeryCoin
    bool fStrictPayToScriptHash = true; // Always active in MontgomeryCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "MontgomeryCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Loving Larry - September 4th 2017";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xd6fe72af0d50ac1fd8f25fb2a862d454f3c93f964b7522ad8e8b3f3b17544dab"));
